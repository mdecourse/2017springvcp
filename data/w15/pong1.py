# author: monomorium 
# source: https://www.ptt.cc/bbs/Python/M.1223105029.A.E2C.html
import pygame
...
prompt = {1:"1. 開始遊戲", 2:"2. 電腦模擬", 3:"3. 退出遊戲"}
...
def ballcontrol(point, radius, dx, dy, seconds, bat_score, player_score):
    ...
    return int(x), int(y), dx, dy, bat_score, player_score
...
def menu(screen, prompt):
    ...
    font = pygame.font.Font('fireflysung.ttf', 40)
